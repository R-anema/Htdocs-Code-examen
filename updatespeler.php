...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <input type="submit" value="submit" name="updateSpeler"></input>
</form>
...
if (isset($_POST['spelerID']) && !empty($_POST['spelerID'])) {
...
$updateSpeler = $db->updateSpeler($spelerID, $schoolID, $roepnaam, $tus, $achternaam);
